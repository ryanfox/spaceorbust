...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('launch_game', (
            ...
            ('drawpile', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['launch.Hand'], related_name='drawpile')),
            ('discardpile', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['launch.Hand'], related_name='discardpile')),
            ('launchpad', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['launch.Hand'], related_name='launchpad')),
        ...
        # Adding model 'Suit'
        db.create_table('launch_suit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('suit', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('launch', ['Suit'])

        # Adding model 'Card'
        db.create_table('launch_card', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('suit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['launch.Suit'])),
    ...
    models = {
        ...
        'launch.card': {
            ...
            'suit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['launch.Suit']"})
        },
        'launch.game': {
            'Meta': {'object_name': 'Game'},
            'clocks': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'discardpile': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['launch.Hand']", 'related_name': "'discardpile'"}),
            'drawpile': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['launch.Hand']", 'related_name': "'drawpile'"}),
            'fuses': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ispublic': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'launchpad': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['launch.Hand']", 'related_name': "'launchpad'"}),
